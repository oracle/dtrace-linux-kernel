...
#define DECLARE_IDTENTRY_VC(vector, func)				\
	...
	__visible noinstr int kernel_##func(struct pt_regs *regs, unsigned long error_code);	\
	__visible noinstr int   user_##func(struct pt_regs *regs, unsigned long error_code)
